...
export const articles: Article[] = [
  {
    id: "1",
    slug: "return-of-silence",
    category: "observation",
    title: "The Return of Silence",
    excerpt: "In a season of maximalism, a quiet movement emerges. Designers are rediscovering the power of restraint.",
    date: "2026.04.02",
    readTime: 6,
    featured: true,
    content: `
...
*Observation from the Spring/Summer 2026 collections. Data analyzed through CLIP-based image classification and trend clustering.*
  ...
  {
    id: "2",
    slug: "material-as-philosophy",
    category: "insight",
    title: "Material as Philosophy",
    excerpt: "Why raw silk and unbleached cotton are becoming the new luxury language. The Dao of fabric.",
    date: "2026.03.28",
    readTime: 9,
    content: `
...
*Analysis based on material sourcing data from 200+ contemporary fashion brands, 2024-2026.*
  ...
  {
    id: "3",
    slug: "doing-less-lemaire",
    category: "essence",
    title: "Lemaire: The Art of Doing Less",
    excerpt: "Christophe Lemaire on intentionality, elimination, and the quiet confidence of clothes that don't try too hard.",
    date: "2026.03.20",
    readTime: 12,
    content: `
...
// Additional articles - batch 2
articles.push(
  {
    id: "4",
    slug: "void-in-fashion",
    category: "void",
    title: "The Void: Presence in Absence",
    excerpt: "Exploring negative space in garment design. When what is removed becomes more powerful than what remains.",
    date: "2026.04.05",
    readTime: 7,
    content: `
...
Rei Kawakubo's Spring 2026 collection for Comme des Garçons featured garments with literal holes—strategic absences where fabric should be. Critics called it deconstruction. But it was something more precise: an assertion that clothing need not cover to clothe.
...
*Observation from the Spring/Summer 2026 collections.*
  ...
  {
    id: "5",
    slug: "slow-revolution",
    category: "insight",
    title: "The Slow Revolution",
    excerpt: "Why the fastest trend in fashion is the decision to stop chasing trends entirely.",
    date: "2026.04.08",
    readTime: 10,
    content: `
...
*Analysis of 150+ brands with extended production cycles and lifetime repair policies.*
  ...
  {
    id: "6",
    slug: "issey-miyake-pleats",
    category: "essence",
    title: "Issey Miyake: The Geometry of Flow",
    excerpt: "How one designer merged technology and nature to create garments that move like water and hold shape like stone.",
    date: "2026.04.10",
    readTime: 11,
    content: `
...
*Studio visit and archive research, Tokyo, February 2026.*
  ...
  {
    id: "7",
    slug: "wabi-sabi-fashion",
    category: "insight",
    title: "Wabi-Sabi: The Beauty of Imperfection",
    excerpt: "How Japanese aesthetics of impermanence and incompleteness are reshaping contemporary fashion.",
    date: "2026.04.12",
    readTime: 10,
    content: `
...
*Analysis based on data from 5 major fashion sources, April 2026.*
  ...
  {
    id: "8",
    slug: "quiet-luxury-data",
    category: "observation",
    title: "The Numbers Behind Quiet Luxury",
    excerpt: "Data reveals: the fastest growing trend in fashion is the trend toward no trends at all.",
    date: "2026.04.15",
    readTime: 7,
    content: `
...
|*Data analysis from Vogue, Pinterest, WWD, Instagram, and brand direct reporting.*
  ...
  {
    id: "9",
    slug: "the-row-silent-luxury",
    category: "essence",
    title: "The Row: Silent Luxury in Practice",
    excerpt: "How Mary-Kate and Ashley Olsen built an empire on the power of absence. The purest expression of Daoist fashion.",
    date: "2026.04.17",
    readTime: 8,
    featured: false,
    content: `
...
And that, ultimately, is the Daoist ideal — not the accumulation of possessions, but the elimination of everything that stands between you and your essential nature.
  ...
  {
    id: "10",
    slug: "capsule-wardrobe-daoist-practice",
    category: "insight",
    title: "Capsule Wardrobe as Daoist Practice",
    excerpt: "The capsule wardrobe movement aligns with ancient Daoist wisdom about the relationship between possession and peace.",
    date: "2026.04.19",
    readTime: 7,
    featured: false,
    content: `
...
"Return is the motion of the Dao," Laozi taught. The capsule wardrobe practitioner returns, again and again, to simplicity. And in that return, finds something that no amount of shopping can purchase: the peace of enough.
  ...
  {
    id: "11",
    slug: "natural-dye-colors-of-earth",
    category: "essence",
    title: "Natural Dye: The Colors of Earth",
    excerpt: "Natural dye offers an alternative philosophy — one that embraces rather than fights the nature of material existence and impermanence.",
    date: "2026.04.24",
    readTime: 8,
    featured: false,
    content: `
