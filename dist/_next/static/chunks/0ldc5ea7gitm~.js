(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52683,e=>{"use strict";var t=e.i(43476),a=e.i(71645),s=e.i(22016),i=e.i(74442);let o=[{label:"Observation",href:"/observation"},{label:"Insight",href:"/insight"},{label:"Essence",href:"/essence"},{label:"Void",href:"/void"}];function n(){let[e,n]=(0,a.useState)(!1),[r,l]=(0,a.useState)(!0),[h,c]=(0,a.useState)(0);return(0,a.useEffect)(()=>{let e=()=>{let e=window.scrollY;if(e<100){l(!0),c(e);return}e>h?l(!1):l(!0),c(e)};return window.addEventListener("scroll",e,{passive:!0}),()=>window.removeEventListener("scroll",e)},[h]),(0,t.jsxs)("nav",{className:`fixed top-0 left-0 right-0 z-50 bg-[var(--color-bg)]/95 backdrop-blur-sm border-b border-[var(--color-border)] transition-transform duration-300 ${r?"translate-y-0":"-translate-y-full"}`,children:[(0,t.jsxs)("div",{className:"max-w-7xl mx-auto px-6 py-4 flex justify-between items-center",children:[(0,t.jsxs)(s.default,{href:"/",className:"text-xl tracking-[0.15em] font-medium",style:{fontFamily:"var(--font-display)"},children:["LAOZI",(0,t.jsx)("span",{className:"opacity-40",children:"."}),"ART"]}),(0,t.jsxs)("div",{className:"hidden md:flex items-center space-x-8",children:[o.map(e=>(0,t.jsx)(s.default,{href:e.href,className:"nav-link text-sm tracking-widest uppercase opacity-60 hover:opacity-100 transition-opacity",children:e.label},e.label)),(0,t.jsx)("div",{className:"pl-4 border-l border-[var(--color-border)]",children:(0,t.jsx)(i.LoginButton,{})})]}),(0,t.jsx)("button",{onClick:()=>n(!e),className:"md:hidden p-2","aria-label":"Toggle menu",children:(0,t.jsxs)("div",{className:"w-6 h-5 relative flex flex-col justify-between",children:[(0,t.jsx)("span",{className:`w-full h-px bg-[var(--color-text)] transition-transform duration-300 ${e?"rotate-45 translate-y-2":""}`}),(0,t.jsx)("span",{className:`w-full h-px bg-[var(--color-text)] transition-opacity duration-300 ${e?"opacity-0":""}`}),(0,t.jsx)("span",{className:`w-full h-px bg-[var(--color-text)] transition-transform duration-300 ${e?"-rotate-45 -translate-y-2":""}`})]})})]}),(0,t.jsx)("div",{className:`md:hidden absolute top-full left-0 right-0 bg-[var(--color-bg)] border-t border-[var(--color-border)] overflow-hidden transition-all duration-300 ease-out ${e?"max-h-96 opacity-100":"max-h-0 opacity-0"}`,children:(0,t.jsx)("div",{className:"py-8",children:(0,t.jsxs)("div",{className:"flex flex-col items-center space-y-6",children:[o.map((a,i)=>(0,t.jsx)(s.default,{href:a.href,onClick:()=>n(!1),className:`text-sm tracking-widest uppercase opacity-60 hover:opacity-100 transition-all duration-300 ${e?"translate-y-0 opacity-60":"translate-y-4 opacity-0"}`,style:{transitionDelay:e?`${50*i}ms`:"0ms"},children:a.label},a.label)),(0,t.jsx)("div",{className:`pt-4 border-t border-[var(--color-border)] transition-all duration-300 ${e?"translate-y-0 opacity-100":"translate-y-4 opacity-0"}`,style:{transitionDelay:e?"200ms":"0ms"},children:(0,t.jsx)(i.LoginButton,{})})]})})})]})}function r(){let[e,s]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{s(!0)},[]),(0,t.jsxs)("section",{className:"section-padding min-h-screen flex flex-col justify-center items-center text-center px-6",children:[(0,t.jsxs)("div",{className:`max-w-4xl mx-auto transition-all duration-1000 ${e?"opacity-100 translate-y-0":"opacity-0 translate-y-8"}`,children:[(0,t.jsx)("p",{className:"text-[#8a8a8a] text-sm tracking-[0.5em] mb-8",children:"道法自然"}),(0,t.jsxs)("h1",{className:"heading-xl mb-8",children:["The Essence",(0,t.jsx)("br",{}),(0,t.jsx)("span",{className:"text-[#8a8a8a]",children:"Beyond"})," Trend"]}),(0,t.jsx)("p",{className:"body-lg max-w-2xl mx-auto mb-12",children:"Observing fashion through the lens of Daoist philosophy. Less noise, more essence. A quiet space in a loud industry."}),(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center items-center",children:[(0,t.jsx)("a",{href:"/observation",className:"px-8 py-3 border border-[#1a1a1a] text-sm tracking-widest uppercase hover:bg-[#1a1a1a] hover:text-[#fafafa] transition-colors duration-300",children:"Start Observing"}),(0,t.jsx)("a",{href:"/about",className:"px-8 py-3 text-sm tracking-widest uppercase text-[#8a8a8a] hover:text-[#1a1a1a] transition-colors duration-300",children:"About LAOZI.ART"})]})]}),(0,t.jsx)("div",{className:`absolute bottom-12 left-1/2 -translate-x-1/2 transition-opacity duration-1000 delay-500 ${e?"opacity-100":"opacity-0"}`,children:(0,t.jsx)("div",{className:"w-px h-16 bg-gradient-to-b from-[#1a1a1a] to-transparent"})})]})}let l=[{id:"1",slug:"return-of-silence",category:"observation",title:"The Return of Silence",excerpt:"In a season of maximalism, a quiet movement emerges. Designers are rediscovering the power of restraint.",date:"2026.04.02",readTime:6,featured:!0,content:`
